...
#API Publisher Create and Publish an APIs
  ...
  Scenario Outline: Create SP and Add New Application
    ...
    Examples:
      ...
      |SP       |WSO2Telco     |TElco  |viraj@wso2telco.com|APPNAME|wso2telcoApp01|INACTIVE|
...
@spSubscribeForAPI
  Scenario Outline:  Admin approve the APIs
   ...
   #Service Provider Subscribe an API
    ...
    When I select application as "<appName>"
  ...
  Examples:
    |usertypeSP|apiName |version|appName |AppStatusAfterApprove|AppTier  |
    |SP        |paymentWso2T9  |v1     |APPNAME |ACTIVE    |Unlimited| 
